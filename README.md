...
По существу произведены следующие действия:
Сверстать сайт помакету главной страницы используя возможности HTML5 и CSS3. Предусмотреть:
...
+ Использовать переменные CSS3.
+ Адаптив отсутствует.
Добавить форму обратной связи (или любую другую, если данная форма не подходит ввиду предметной области - в этом случае форма должна не уступать по сложности данной)
Если на странице уже есть форма, то привести ее к структуре ниже. Переход по кнопке в футере в ячейке Your email address!
Поля формы:
* Имя
* Фамилия
* Email
...
* Сообщение (textarea)
* Кнопка *Отправить*
Необходимо использовать input элемент.

На каждое поле добавить валидацию значений
